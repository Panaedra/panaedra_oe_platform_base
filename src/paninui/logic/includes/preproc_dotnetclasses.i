/******************************  Dvcs_ Header ********************************\
  ...
  Date Modified: $Modtime: 2010-01-04 12:01:52+01:00 $ 
...
&glob sourcecontrolversions {&sourcecontrolversions} | paninui_logic_includes_preproc_dotnetclasses_i $Revision: 3 $
&if '{&class}' = '' &then
procedure dvcs__paninui_logic_includes_preproc_dotnetclasses_i: return "$Revision: 3 $". end.
&endif
/******************************* $NoKeywords:  $ *****************************/

...
/******************************  Dvcs_ Header ********************************\
  ...
  Date Modified: $Modtime: 2010-02-13 19:38:11+01:00 $ 
...
&glob sourcecontrolversions {&sourcecontrolversions} | paninui_view_use_sc_coll_widgetdata_tt_i $Revision: 8 $
&if '{&class}' = '' &then
procedure dvcs__paninui_view_use_sc_coll_widgetdata_tt_i: return "$Revision: 8 $". end.
&endif
/******************************* $NoKeywords:  $ *****************************/

  define {&protected} {&static} temp-table ttUIFrame no-undo rcode-information
    field iIDUIFrame     as int64                format "->>>,>>>,>>>,>>9"    initial ? xml-node-type "attribute" help " [private-data] CasedTableName=UIFrame " 
  ...
  define {&protected} {&static} temp-table ttWidgetData no-undo rcode-information
    field iIDWidgetData       as int64                format "->>>,>>>,>>>,>>9"    initial ? xml-node-type "attribute"  help " [private-data] CasedTableName=WidgetData " 

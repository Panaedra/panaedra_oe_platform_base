/******************************  Dvcs_ Header ********************************\
  ...
  Date Modified: $Modtime: 2010-02-12 16:35:24+01:00 $ 
...
&glob sourcecontrolversions {&sourcecontrolversions} | panaedra_msroot_msutil_logic_tt_validation_tt_i $Revision: 3 $
/******************************* $NoKeywords:  $ *****************************/
...
define {&protected} {&static} temp-table tt{&ttPrefix}Validation{&ttSuffix} {&no-undo} {&reference-only} {&rcode-information} {&before-table}
  field iIDValidation            as int64       /* This ID is kept throughout the validation life cycle */ help " [private-data] CasedTableName=Validation "

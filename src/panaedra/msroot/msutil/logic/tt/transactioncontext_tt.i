/******************************  Dvcs_ Header ********************************\
  ...
  Date Modified: $Modtime: 2010-02-09 17:24:53+01:00 $ 
...
&glob sourcecontrolversions {&sourcecontrolversions} | panaedra_msroot_msutil_logic_tt_transactioncontext_tt_i $Revision: 2 $
/******************************* $NoKeywords:  $ *****************************/
...
define {&protected} {&static} temp-table tt{&ttPrefix}TransactionContext{&ttSuffix} {&no-undo} {&reference-only} {&rcode-information} {&before-table}
  field iIDTransactionContext    as int64       /* This ID is kept throughout the "logical-transaction" life cycle                             */ help " [CasedTableName] TransactionContext "

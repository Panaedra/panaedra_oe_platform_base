/******************************  Dvcs_ Header ********************************\
  ...
  Date Modified: $Modtime: 2010-02-09 17:27:19+01:00 $ 
...
&glob sourcecontrolversions {&sourcecontrolversions} | panaedra_msroot_msutil_logic_tt_validationerror_tt_i $Revision: 2 $
/******************************* $NoKeywords:  $ *****************************/
...
define {&protected} {&static} temp-table tt{&ttPrefix}ValidationError{&ttSuffix} {&no-undo} {&reference-only} {&rcode-information} {&before-table}
  field iIDValidationError    as int64       help " [CasedTableName] ValidationError "

/******************************  Dvcs_ Header ********************************\
  ...
  Date Modified: $Modtime: 2010-02-09 17:27:50+01:00 $ 
...
&glob sourcecontrolversions {&sourcecontrolversions} | panaedra_msroot_msutil_logic_tt_validationquestion_tt_i $Revision: 2 $
/******************************* $NoKeywords:  $ *****************************/
...
define {&protected} {&static} temp-table tt{&ttPrefix}ValidationQuestion{&ttSuffix} {&no-undo} {&reference-only} {&rcode-information} {&before-table}
  field iIDValidationQuestion    as int64       help " [CasedTableName] ValidationQuestion "
